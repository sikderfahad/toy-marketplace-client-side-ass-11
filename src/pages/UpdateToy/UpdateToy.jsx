...
const UpdateToy = () => {
  ...
  return (
    <div className="w-11/12 md:w-1/2 mx-auto p-10 bg-gray-900 rounded-xl">
      <form onSubmit={handledUpdateToy}>
        ...
        <div className="text-center">
          <button
            type="submit"
            className="text-white w-1/2 mx-auto mt-6 bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br  shadow-lg shadow-green-500/50  font-medium rounded-lg text-lg md:text-xl px-5 py-2.5 text-center"
          >
            Add New Toy
          </button>
        </div>
